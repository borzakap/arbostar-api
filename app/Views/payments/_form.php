<div class="row">
    <div class="col-md-6 mt-3">
        ...
        <?= form_dropdown('contragent_id', $contragents, $item->contragent_id, ['class' => 'form-select', 'id' => 'contragent_id']) ?>
    </div>
    <div class="col-md-6 mt-3">
        <?= form_label(lang('Forms.Labels.CurrencyName'), 'currency_id', ['class' => 'form-label']) ?>
        <?= form_dropdown('currency_id', $currencites, $item->currency_id, ['class' => 'form-select', 'id' => 'currency_id']) ?>
    </div>
    <div class="col-md-6 mt-3">
    ...
    <div class="col-md-6 mt-3">
        ...
        <?= form_input(['name' => 'payment_at', 'class' => 'form-control', 'id' => 'payment_at', 'type' => 'date', 'value' => old('payment_at') ?? $item->payment_at->toDateString() ?? '']) ?>
    </div>
</div>